...
public class Area {
    ...
    public static void save(String path,Location loc1,Location loc2){
        ...
        Eventminigame.getInstance().getConfig().set(path+"pos1.x",loc1.getX());
        Eventminigame.getInstance().getConfig().set(path+"pos1.y",loc1.getY());
        Eventminigame.getInstance().getConfig().set(path+"pos1.z",loc1.getZ());
        Eventminigame.getInstance().getConfig().set(path+"pos2.x",loc2.getX());
        Eventminigame.getInstance().getConfig().set(path+"pos2.y",loc2.getY());
        Eventminigame.getInstance().getConfig().set(path+"pos2.z",loc2.getZ());
